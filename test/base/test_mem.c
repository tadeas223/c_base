...
static void
test_m_memory_base_set_get_default() {
    int test = 0;
    /* Test the poiter idk */
...
static void
test_m_arena_begin_reserve_base() {
    m_Arena arena;
...
static void
test_m_pool_begin_base_reserve() {
    m_Pool pool;
