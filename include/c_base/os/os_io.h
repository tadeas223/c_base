...
Result(String) os_file_read_until(Arena *arena, File* file);
...
Result(String) os_file_one_read_len(Arena *arena, String filepath, u32 len);
Result(String) os_file_one_read_all(Arena *arena, String filepath);
Result(String) os_file_one_read_until(Arena *arena, String filepath);
